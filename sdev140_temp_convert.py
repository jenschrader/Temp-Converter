...
class ConvertTempGui:
    def __init__(self):
        ...
        self.HeadingLabel = tkinter.Label(
            self.TopFrame,
            text='Enter a temperature below',
            font=('Silkscreen regular', 20),
            bg='#bac3f1',
            fg='white',
            justify='center')
        
        self.FahrLabel = tkinter.Label(
            self.MiddleFrame,
            text='Convert to Fahrenheit',
            font=('Silkscreen Regular', 16),
            bg='#bac3f1',
            fg='white',
            wraplength=200,
            justify='center')
        
        self.CelsLabel = tkinter.Label(
            self.MiddleFrame,
        ...
        self.DisplayTemp = tkinter.Label(
            self.BottomFrame,
            textvariable=self.ConversionValue,
            font=('VT323', 80),
            bg='#bac3f1',
            fg='white')
        ...
        # *-- text entry --*
        # *************************************
        self.TempEntry = tkinter.ttk.Entry(
            self.TopFrame,
            font=('VT323 20'),
            width=4,
            justify='center')
        ...
        # create buttons
        self.ConvertFahr = tkinter.Button(
            self.MiddleFrame,
            image=self.FahrImage,
            bg='#bac3f1',
            border=0)
        
        self.ConvertCels = tkinter.Button(
            self.MiddleFrame,
            image=self.CelsImage,
            bg='#bac3f1',
            border=0)
